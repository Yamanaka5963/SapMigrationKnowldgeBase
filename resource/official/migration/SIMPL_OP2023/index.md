...
3. **優先確認領域：** ACDOCA・MATDOC・PRCD_ELEMENTS・CVI・Pool Tables は全案件で必須確認
4. **業種モジュール：** 44〜63章は業種固有。対象外業種はスキップ可
5. **SAP Note：** 各項目に SAP Note 番号が記載されている。最新の修正・回避策は Note を確認
